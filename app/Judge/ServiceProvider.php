...
class ServiceProvider extends LaravelServiceProvider
{
    public function register()
    {
        ...
        $this->app->singleton(
            'Judge\Repositories\SolutionStateRepository',
            function () use ($solution_state_repository) {
                return $solution_state_repository;
            }
        );

        $solution_repository = new \Judge\Repositories\SolutionRepository(
            $contest_repository,
            $problem_repository,
            $solution_state_repository
        );
